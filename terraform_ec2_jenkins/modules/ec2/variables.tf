...
#   description = "Name of the custom ami that will be used"
#   type        = string
#   default     = ""
# }
...
variable "user_data_replace_on_change" {
  description = "If there is a change to the user_data block of the EC2 resource, Terraform will not replace the existing value with a new value during an update. Instead, it will keep the existing value."
  type = bool
  default = null
}